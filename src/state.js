...
const Ex5 = function() {
  ...
  return (
    <div>
      <p>{count}</p>
      <button onClick={() => setCount(count + 1)} /* Add something here */>
        Click me!
      </button>
    </div>
  );
...
const Ex6 = function() {
  ...
  return (
    <div>
      <p>
        {fib[0]}/* The value you should put here is: `fib[0]`, but this will
        only work after you set the initial state */}
      </p>
      <button
        onClick={() => {
          setFib(prev => {
...
const Ex7 = function() {
  ...
  return (
    <div>
      ...
      <button /* Add something here */>click me</button>
    </div>
  );
};
...
const Ex8 = function() {
  ...
  return (
    <div>
      ...
      <button /* Add something here */>fruit</button>
      <button /* Add something here */>meat</button>
      <button /* Add something here */>vegetables</button>
    </div>
  );
};
...
const Ex9 = function() {
  ...
  return (
    <div>
      ...
      <button /* Add something here */>UPPER</button>
      <button /* Add something here */>LOWER</button>
    </div>
  );
};
